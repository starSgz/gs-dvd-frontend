<template>
   <div class="app-container" style="padding: 20px; background: #faf9f5;">
      <SystemPageLayout title="操作日志" :total="total" :show-filter="showSearch">
         <template #filter>
            <el-form :model="queryParams" ref="queryRef" label-position="top" size="small" class="system-filter-form">
               <div class="system-filter-grid">
                  ...
                  <el-form-item label="操作时间" class="system-filter-span-2">
                     <el-date-picker
                        v-model="dateRange"
         ...
         <div class="system-table-wrap">
            <el-table ref="operlogRef" v-loading="loading" :data="operlogList" class="system-data-table" border @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
