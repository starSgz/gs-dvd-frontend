<template>
   <div class="app-container" style="padding: 20px; background: #faf9f5;">
      <SystemPageLayout title="字典类型列表" :total="total" :show-filter="showSearch">
         <template #filter>
         ...
         <div class="system-table-wrap">
            <el-table v-loading="loading" :data="typeList" class="system-data-table" border @selection-change="handleSelectionChange">
